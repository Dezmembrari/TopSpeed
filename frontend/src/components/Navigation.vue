<template>
   ...
   <header :class="{'scrolled-nav': scrolledNav}">
    <!--Top banner-->
    <div
      v-if="!scrolledNav && !mobileBanner"
      class="top-banner-0w3mEM"
      data-id="244:1198"
    >
      <div class="contact-727KgL" data-id="244:1199">
        <div class="telefon-E0lKG6" data-id="244:1200">
          ...
          />
          <div
            class="x0788-990-011-0TmUck x0788-990-011 inter-normal-white-14-5px"
            data-id="244:1202"
          >
        ...
        <div class="email-E0lKG6" data-id="244:1203">
          ...
          />
          <div
            class="officetopspeedserviceeu-HSA5eX officetopspeedserviceeu inter-normal-white-14-5px"
            data-id="244:1205"
          >
            <a
      ...
      <div class="program-727KgL" data-id="244:1206">
        ...
        />
        <div
          class="luni-vineri-0800-cmdIc7 inter-normal-white-14-5px"
          data-id="244:1208"
        >
